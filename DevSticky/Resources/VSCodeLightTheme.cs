...
/// <summary>
/// VSCode Light+ inspired syntax highlighting colors for all supported languages:
/// C#, Java, JavaScript, TypeScript, JSON, XML, SQL, Python, Bash
/// </summary>
public static class VSCodeLightTheme
{
    // VSCode Light+ color palette
    public static readonly WpfColor Comment = WpfColor.FromRgb(0x00, 0x80, 0x00);      // Green comments
    public static readonly WpfColor String = WpfColor.FromRgb(0xA3, 0x15, 0x15);       // Dark red strings
    public static readonly WpfColor Keyword = WpfColor.FromRgb(0x00, 0x00, 0xFF);      // Blue keywords
    public static readonly WpfColor ControlKeyword = WpfColor.FromRgb(0xAF, 0x00, 0xDB); // Purple control flow
    public static readonly WpfColor Type = WpfColor.FromRgb(0x26, 0x7F, 0x99);         // Teal types
    public static readonly WpfColor Number = WpfColor.FromRgb(0x09, 0x86, 0x58);       // Green numbers
    public static readonly WpfColor Function = WpfColor.FromRgb(0x79, 0x5E, 0x26);     // Brown functions
    public static readonly WpfColor Variable = WpfColor.FromRgb(0x00, 0x1E, 0x8C);     // Dark blue variables
    public static readonly WpfColor Operator = WpfColor.FromRgb(0x00, 0x00, 0x00);     // Black operators
    public static readonly WpfColor Punctuation = WpfColor.FromRgb(0x39, 0x39, 0x39);  // Dark gray punctuation
    public static readonly WpfColor Preprocessor = WpfColor.FromRgb(0xAF, 0x00, 0xDB); // Purple preprocessor
    public static readonly WpfColor XmlTag = WpfColor.FromRgb(0x80, 0x00, 0x00);       // Dark red XML/HTML tags
    public static readonly WpfColor XmlAttribute = WpfColor.FromRgb(0xFF, 0x00, 0x00); // Red attributes
    public static readonly WpfColor XmlValue = WpfColor.FromRgb(0x00, 0x00, 0xFF);     // Blue attribute values
    public static readonly WpfColor JsonKey = WpfColor.FromRgb(0x0A, 0x51, 0x95);      // Blue JSON keys
    public static readonly WpfColor Regex = WpfColor.FromRgb(0x81, 0x17, 0x17);        // Dark red regex
    public static readonly WpfColor Escape = WpfColor.FromRgb(0xEE, 0x00, 0x00);       // Red escape chars
    public static readonly WpfColor Constant = WpfColor.FromRgb(0x00, 0x00, 0xFF);     // Blue constants
    public static readonly WpfColor SqlKeyword = WpfColor.FromRgb(0x00, 0x00, 0xFF);   // Blue SQL keywords
    public static readonly WpfColor SqlFunction = WpfColor.FromRgb(0x79, 0x5E, 0x26);  // Brown SQL functions
    public static readonly WpfColor Default = WpfColor.FromRgb(0x00, 0x00, 0x00);      // Default text (black)
    ...
    private static void ApplyColorByName(HighlightingColor color, string name)
    {
        ...
        // Default - darken light colors for light theme
